...
export function normalizeBriefingTime(val: unknown): string | null | undefined {
...
const SettingsPatchSchema = z
  .object({
    ...
    daily_briefing_notification_time: z.preprocess(
    ...
    date_display_format: z.enum(["ymd", "dmy", "mdy", "dmy_yy", "dmy_mon_yy"]).optional(),
    clock_display_format: z.enum(["12h", "24h"]).optional(),
  })
  .strict();

export const UserSettingsPatchSchema = SettingsPatchSchema;

export const UserSettingsBodyPatchSchema = z
  .object({
...
export type UserSettingsBodyPatch = z.infer<typeof UserSettingsBodyPatchSchema>;
...
export function saveErrorDetails(e: unknown): string | undefined {
...
export function trimProfileField(v: string | null | undefined | unknown): string | null | undefined {
...
export async function ensureSettingsRow(db: SupabaseClient, userId: string) {
...
export async function ensureProfileRow(db: SupabaseClient, user: User) {
...
export async function fetchUserSettingsRow(db: SupabaseClient, userId: string) {
...
export async function buildSettingsPayloadWithDb(user: User, db: SupabaseClient): Promise<SettingsPayload> {
...
export async function buildSettingsPayload(user: User, auth: SupabaseClient): Promise<SettingsPayload> {
